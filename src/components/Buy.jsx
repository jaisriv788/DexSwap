        ...
        <div className="bg-card border border-border rounded-2xl p-4 sm:p-6 w-full max-w-md shadow-2xl backdrop-blur-sm overflow-hidden">
          <div className="space-y-4">
            ...
            <button
              ...
              className={`w-full cursor-pointer bg-accent text-accent-foreground py-4 rounded-xl font-semibold hover:scale-105 transition-all duration-300 shadow-lg backdrop-blur-sm border border-accent/20`}
            >
              Buy
            </button>
          </div>
